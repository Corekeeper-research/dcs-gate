...
The v2 stack is a 3,000-LOC Go binary, 51 tests, triple baseline corpus of 61 hand-annotated vectors, 14 formal markers, 20 intent categories. Local-first, Ollama-only, no external APIs.
...
• **Devin AI (Cognition)** — executed the v2: backend (3k LOC, 51 tests), frontend, tests, deployment, notebooks, docs.
...
**I'm looking for:**
🔬 GPU compute (≥24 GB VRAM, ~50 hours) to validate the recursive judge hypothesis
