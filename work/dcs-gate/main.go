...
func main() {
	...
	mux.HandleFunc("/auth/stream", authStreamHandler)       // mode=both|analyze|refine
	mux.HandleFunc("/analyze/stream", analyzeStreamHandler) // explícito análisis
	mux.HandleFunc("/refine/stream", refineStreamHandler)   // explícito refinado
